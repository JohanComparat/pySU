...
ll = n.array( glob.glob( "/data2/DATA/eBOSS/Multidark-lightcones/MD_2.5Gpc/*.fits" ) )
...
for ii in n.arange(len(ll)):
	...
	for jj in range(len(vbins)-1):
		...
		box.compute2PCF(self,incat,outfile,vmin=vbins[jj],vmax=vbins[jj+1],rmin=4,rmax=60):
