...
for ii in n.arange(len(box.snl)):
	box.computeSingleDistributionFunction(ii,'vmax', 10**n.arange(0,3.5,0.01))

for ii in n.arange(len(box.snl)):
	box.combinesSingleDistributionFunction(ii,'vmax', 10**n.arange(0,3.5,0.01),type = "Central")
	box.combinesSingleDistributionFunction(ii,'vmax', 10**n.arange(0,3.5,0.01),type = "Satellite")
