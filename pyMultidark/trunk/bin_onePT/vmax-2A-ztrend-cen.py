...
outfile=open(join(dir,qty,"vmax-"+cos+"-diff-function-z0-params.pkl"), 'r')
...
y_data_04 = n.log10( norm * (10**x_data_04)**3. * data["dNdVdlnM_"+cos][MD04])
...
y_data_10 = n.log10( norm * (10**x_data_10)**3. * data["dNdVdlnM_"+cos][MD10]) 
...
y_data_25 = n.log10( norm * (10**x_data_25)**3. * data["dNdVdlnM_"+cos][MD25])
...
y_data_40 = n.log10( norm * (10**x_data_40)**3. * data["dNdVdlnM_"+cos][MD40])
...
y_data = n.log10( norm * (10**x_data)**3. * data["dNdVdlnM_"+cos][ok])
