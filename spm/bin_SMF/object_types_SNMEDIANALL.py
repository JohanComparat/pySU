...
ok_boss_02 = (error_reliable_boss) & (mass_reliable_boss_02) & (redshift_reliable_boss) & ( boss['SN_MEDIAN_ALL']>0)
ok_sdss_02 = (error_reliable_sdss) & (mass_reliable_sdss_02) & (redshift_reliable_sdss) & ( sdss['SN_MEDIAN_ALL']>0)
ok_boss_04 = (error_reliable_boss) & (mass_reliable_boss_04) & (redshift_reliable_boss) & ( boss['SN_MEDIAN_ALL']>0)
ok_sdss_04 = (error_reliable_sdss) & (mass_reliable_sdss_04) & (redshift_reliable_sdss) & ( sdss['SN_MEDIAN_ALL']>0)
...
sn_02 = n.hstack(( boss['SN_MEDIAN_ALL'][ok_boss_02], sdss['SN_MEDIAN_ALL'][ok_sdss_02] ))

zz_04 = n.hstack(( boss['Z_NOQSO'][ok_boss_04], sdss['Z'][ok_sdss_04]))
sn_04 = n.hstack(( boss['SN_MEDIAN_ALL'][ok_boss_04], sdss['SN_MEDIAN_ALL'][ok_sdss_04] ))


####################SN MEDIAN ALL vs. MASS ERROR ##################


Ms_log_err = n.hstack(( (n.log10(boss[stellar_mass+'_up'][redshift_reliable_boss & error_reliable_boss]) - n.log10(boss[stellar_mass+'_low'][redshift_reliable_boss & error_reliable_boss]))/2., (n.log10(sdss[stellar_mass+'_up'][redshift_reliable_sdss & error_reliable_sdss]) - n.log10(sdss[stellar_mass+'_low'][redshift_reliable_sdss & error_reliable_sdss]))/2.))

sn_all = n.hstack(( boss['SN_MEDIAN_ALL'][redshift_reliable_boss & error_reliable_boss], sdss['SN_MEDIAN_ALL'][redshift_reliable_sdss & error_reliable_sdss] ))
...
p.savefig(os.path.join(out_dir, "SN_MEDIAN_ALL_stellar_mass_err_sdss_boss.jpg" ))
p.clf()
...
p.grid()
p.title('SDSS and BOSS')
p.savefig(os.path.join(out_dir, "SN_MEDIAN_ALL_redshift_sdss_boss.jpg" ))
p.clf()
...
p.grid()
p.title('SDSS and BOSS')
p.savefig(os.path.join(out_dir, "SN_MEDIAN_ALL_redshift_sdss_boss_04.jpg" ))
p.clf()
...
Ms_02 = deep2['SN_MEDIAN_ALL'][deep2_sel_02]
zz_02 = deep2[z_name][deep2_sel_02]
Ms_04 = deep2['SN_MEDIAN_ALL'][deep2_sel_04]
...
p.grid()
p.title('DEEP2')
p.savefig(os.path.join(out_dir, "SN_MEDIAN_ALL_mass_deep2.jpg" ))
p.clf()
...
p.grid()
p.title('DEEP2')
p.savefig(os.path.join(out_dir, "SN_MEDIAN_ALL_mass_deep2_04.jpg" ))
p.clf()
