...
env = 'DATA_DIR'
spec_dir = join( os.environ[env], "spm", "GAMAmock", "spectra")
...
summary_catalog = join( os.environ[env], "spm", "GAMAmock", "catalogs", "GAMA.mock.spectra.spm.fits")

headers_base ="ID" 
header_i = n.array(["age_lightW", "age_lightW_err_plus", "age_lightW_err_minus", "metallicity_lightW", "metallicity_lightW_err_plus", "metallicity_lightW_err_minus", "age_massW", "age_massW_err_plus", "age_massW_err_minus", "metallicity_massW", "metallicity_massW_err_plus", "metallicity_massW_err_minus", "stellar_mass", "stellar_mass_err_plus", "stellar_mass_err_minus", "spm_EBV", "nComponentsSSP", "chi2red"])


dV=-9999.99
def get_table_entry_full(hduSPM):
	return n.array([ 10**hduSPM.header['age_lightW'], 10**hduSPM.header['age_lightW_up']-10**hduSPM.header['age_lightW'], 10**hduSPM.header['age_lightW']-10**hduSPM.header['age_lightW_low'], hduSPM.header['metallicity_lightW'], hduSPM.header['metallicity_lightW_up'] - hduSPM.header['metallicity_lightW'], hduSPM.header['metallicity_lightW'] - hduSPM.header['metallicity_lightW_low'], 10**hduSPM.header['age_massW'], 10**hduSPM.header['age_massW_up']-10**hduSPM.header['age_massW'], 10**hduSPM.header['age_massW']-10**hduSPM.header['age_massW_low'], hduSPM.header['metallicity_massW'], hduSPM.header['metallicity_massW_up'] - hduSPM.header['metallicity_massW'], hduSPM.header['metallicity_massW'] - hduSPM.header['metallicity_massW_low'], hduSPM.header['stellar_mass'], hduSPM.header['stellar_mass_up'] - hduSPM.header['stellar_mass'], hduSPM.header['stellar_mass'] - hduSPM.header['stellar_mass_low'], hduSPM.header['EBV'], hduSPM.header['ssp_number'], hduSPM.header['chi2']])
