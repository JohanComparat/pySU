...
bins = n.arange(-0.75, 0.76, 0.025 )
p.figure(0, (4.5,4.5))
p.axhline(0.5, ls='dashed', c='k')
p.hist(1+cat['input_stellar_mass']-cat['stellar_mass_Chabrier_stelib'], label='cs',rasterized=True, histtype='step', bins=bins, normed=True, cumulative = True)
p.hist(1+cat['input_stellar_mass']-cat['stellar_mass_Chabrier_miles'] , label='cm',rasterized=True, histtype='step', bins=bins, normed=True, cumulative = True)
p.hist(1+cat['input_stellar_mass']-cat['stellar_mass_Chabrier_elodie'], label='ce',rasterized=True, histtype='step', bins=bins, normed=True, cumulative = True)
p.hist(1+cat['input_stellar_mass']-cat['stellar_mass_Kroupa_stelib']  , label='ks',rasterized=True, histtype='step', bins=bins, normed=True, cumulative = True)
p.hist(1+cat['input_stellar_mass']-cat['stellar_mass_Kroupa_miles']   , label='km',rasterized=True, histtype='step', bins=bins, normed=True, cumulative = True)
p.hist(1+cat['input_stellar_mass']-cat['stellar_mass_Kroupa_elodie']  , label='ke',rasterized=True, histtype='step', bins=bins, normed=True, cumulative = True)
p.hist(1+cat['input_stellar_mass']-cat['stellar_mass_Salpeter_stelib'], label='ss',rasterized=True, histtype='step', bins=bins, normed=True, cumulative = True)
p.hist(1+cat['input_stellar_mass']-cat['stellar_mass_Salpeter_miles'] , label='sm',rasterized=True, histtype='step', bins=bins, normed=True, cumulative = True)
p.hist(1+cat['input_stellar_mass']-cat['stellar_mass_Salpeter_elodie'], label='se',rasterized=True, histtype='step', bins=bins, normed=True, cumulative = True)
p.xlim((-0.6,0.6))
p.xlabel(r'$1+\Delta\log(M)$')
