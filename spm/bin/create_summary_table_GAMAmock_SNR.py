...
summary_catalog = join(spec_dir, "catalogs", "GAMA.mock.spectra.spm.SNR.fits")

headers_base =" ID" 
header_i = n.array(["age_lightW", "age_lightW_err_plus", "age_lightW_err_minus", "metallicity_lightW", "metallicity_lightW_err_plus", "metallicity_lightW_err_minus", "stellar_mass", "stellar_mass_err_plus", "stellar_mass_err_minus", "spm_EBV", "nComponentsSSP", "chi2red", "SNR_multiplicative_value", "medianSNRpp"])


dV=-9999.99
def get_table_entry_full(hduSPM):
	return n.array([ 10**hduSPM.header['age_lightW'], 10**hduSPM.header['age_lightW_up']-10**hduSPM.header['age_lightW'], 10**hduSPM.header['age_lightW']-10**hduSPM.header['age_lightW_low'], hduSPM.header['metallicity_lightW'], hduSPM.header['metallicity_lightW_up'] - hduSPM.header['metallicity_lightW'], hduSPM.header['metallicity_lightW'] - hduSPM.header['metallicity_lightW_low'], hduSPM.header['stellar_mass'], hduSPM.header['stellar_mass_up'] - hduSPM.header['stellar_mass'], hduSPM.header['stellar_mass'] - hduSPM.header['stellar_mass_low'], hduSPM.header['EBV'], hduSPM.header['ssp_number'], hduSPM.header['chi2'], hduSPM.header['SNR_multiplicative_value'], hduSPM.header['medianSNRpp']])
...
for filename in filenames:
	...
	for ii,hdu in enumerate(hdus[1:]):
		...
		add_me = n.array(["_"+suffixes[ii][:-5] for el in header_i])
