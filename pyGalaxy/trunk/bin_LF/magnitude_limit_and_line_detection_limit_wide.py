...
for jj,mag in enumerate(iMags):
	...
	noise_level = lfit.flambda(22.5,8300) / 1.167# 3.56*10**-19
...
n.savetxt("mag-limit-flux-ew-vvdswide.dat",n.transpose([iMags, snr5Flux, snr7Flux, snr5EW, snr7EW]))
n.savetxt("snr-flux-ew-relation-i225-vvdswide.dat",n.transpose([	snrVal, medianFlux, medianEW]))
...
p.grid()
p.legend(loc=3)
p.savefig("../../../../../snr-mag-flux-wide.png")
p.clf()
