...
ok = (gp_SFR_O2_3728>0)& (gp_SFR_O2_3728_err>0)&(spm_stellar_mass >0)

p.figure(0,(6,6))
p.axes([0.17,0.17,0.8,0.8])
p.plot(x_obs_1, y_obs_1, )
p.errorbar(x_obs_1[ok], 12+spm_light_metallicity[ok], yerr=[spm_light_metallicity_err_plus[ok], spm_light_metallicity_err_minus[ok]],fmt=None, mfc='none')
p.plot(x_rel, y_pr, 'k--')
