...
dt=n.loadtxt("photometricFilterDir/decamFilter/decam_u.par",unpack=True)
...
dt=n.loadtxt("photometricFilterDir/decamFilter/decam_g.par",unpack=True)
...
dt=n.loadtxt("photometricFilterDir/decamFilter/decam_r.par",unpack=True)
...
dt=n.loadtxt("photometricFilterDir/decamFilter/decam_i.par",unpack=True)
...
dt=n.loadtxt("photometricFilterDir/decamFilter/decam_z.par",unpack=True)
...
dt=n.loadtxt("photometricFilterDir/cfhtFilter/megacamQE.dat",unpack=True,usecols=(0,1))
qe=interp1d(n.hstack((2000.,dt[0],12000.)),n.hstack((0.,dt[1]/100.,0.)))

wl,u,g,i,r,z=n.loadtxt("photometricFilterDir/cfhtFilter/megacamFilters.dat",unpack=True)
...
dt=n.loadtxt("photometricFilterDir/sdssFilter/up.pb",unpack=True)
...
dt=n.loadtxt("photometricFilterDir/sdssFilter/gp.pb",unpack=True)
...
dt=n.loadtxt("photometricFilterDir/sdssFilter/rp.pb",unpack=True)
...
dt=n.loadtxt("photometricFilterDir/sdssFilter/ip.pb",unpack=True)
...
dt=n.loadtxt("photometricFilterDir/sdssFilter/zp.pb",unpack=True)
