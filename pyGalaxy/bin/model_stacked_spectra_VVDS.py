...
import glob
stack_files=n.hstack(( n.array(glob.glob( "../../LFstacks/*VVDS*linesFittedfireflyFitsMarastonUVext.fits")), n.array(glob.glob( "../../LFstacks/*VVDS*linesFittedfireflyFitsMilesUVextended.fits")) ))
