...
import glob
stack_files_1=n.hstack(( n.array(glob.glob( "../../LFstacks/*DEEP2*linesFittedfireflyFitsMarastonUVext.fits")), n.array(glob.glob( "../../LFstacks/*DEEP2*linesFittedfireflyFitsMilesUVextended.fits")) ))

stack_files_2 = n.hstack(( n.array(glob.glob( "../../LFstacks/*VVDS*linesFittedfireflyFitsMarastonUVext.fits")), n.array(glob.glob( "../../LFstacks/*VVDS*linesFittedfireflyFitsMilesUVextended.fits")) ))
