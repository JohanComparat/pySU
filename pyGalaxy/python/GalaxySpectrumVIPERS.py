...
class GalaxySpectrumVIPERS:
	...
	def __init__(self,catalog_entry,calibration=True,lineFits=False):
		...
		self.vipers_dir = self.database_dir+"VIPERS/"
		self.vipers_catalog_dir = self.vipers_dir+"catalogs/"
		self.vipers_spectra_dir = self.vipers_dir+"spectra/"
	...
	def openObservedSpectrum(self):
		...
		specFileName=self.vipers_spectra_dir+"VIPERS_"+ self.field+ "_PDR1_SPECTRA_1D/"+self.catalog_entry['id_IAU'][:6]+"_"+self.catalog_entry['id_IAU'][7:]+".fits"
