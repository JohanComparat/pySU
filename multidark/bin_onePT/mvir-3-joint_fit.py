...
n.savetxt(join(os.environ['MULTIDARK_LIGHTCONE_DIR'], qty,"mvirFunction_parameters_ST01_MFonly_fit.txt"), n.transpose([pOpt_ST01, pErr_ST01]), header="A a p")
...
n.savetxt(join(os.environ['MULTIDARK_LIGHTCONE_DIR'], qty,"mvirFunction_parameters_BA11_MFonly_fit.txt"), n.transpose([pOpt, pCov.diagonal()**0.5]), header="A a p q")
