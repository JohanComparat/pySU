...
p.savefig(join(os.environ['MULTIDARK_LIGHTCONE_DIR'], 'mvir',"covariance","dn-sigma-jackknife.png"))
p.clf()
...
gl=p.legend(loc=0, frameon=False)
#gl.set_frame_on(False)
p.savefig(join(os.environ['MULTIDARK_LIGHTCONE_DIR'], 'mvir',"covariance","dn-sigma-poisson.png"))
p.clf()
...
gl=p.legend(loc=0, frameon=False)
#gl.set_frame_on(False)
p.savefig(join(os.environ['MULTIDARK_LIGHTCONE_DIR'], 'mvir',"covariance","dn-sigma-both.png"))
p.clf()
...
p.savefig(join(os.environ['MULTIDARK_LIGHTCONE_DIR'], 'mvir',"covariance","covariance_matrix_model.png"))
p.clf()
...
p.xlabel(r'$log_{10}(\sigma_1^{-1})$')
p.ylabel(r'$log_{10}(\sigma_2^{-1})$')
p.savefig(join(os.environ['MULTIDARK_LIGHTCONE_DIR'], 'mvir',"covariance","covariance_matrix_data.png"))
p.clf()
...
p.xlabel(r'$log_{10}(\sigma_1^{-1})$')
p.ylabel(r'$log_{10}(\sigma_2^{-1})$')
p.savefig(join(os.environ['MULTIDARK_LIGHTCONE_DIR'], 'mvir',"covariance","ccr_matrix_model.png"))
p.clf()
...
p.xlabel(r'$log_{10}(\sigma_1^{-1})$')
p.ylabel(r'$log_{10}(\sigma_2^{-1})$')
p.savefig(join(os.environ['MULTIDARK_LIGHTCONE_DIR'], 'mvir',"covariance","ccr_matrix_data.png"))
p.clf()
