...
class InterpretSpectraStacksEBOSS:
	"""
	...
	"""
	def __init__(self, stack_file, index, cosmo=cosmo, dV=-9999.99):
		...
		wl= self.hduStack.data['wavelength']
		self.wlmin = n.min(wl)
		self.wlmax = n.max(wl)
		# opens the spm model
